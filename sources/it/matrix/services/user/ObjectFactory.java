 ...
 * generated in the it.matrix.services.user package. 
...
public class ObjectFactory {
    ...
    private final static QName _UserDetailUserProfileData_QNAME = new QName("http://types.detail.ws.rossoalice.telecomitalia.it", "userProfileData");
    private final static QName _UserDetailUserPersonalData_QNAME = new QName("http://types.detail.ws.rossoalice.telecomitalia.it", "userPersonalData");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.matrix.services.user
     * 
     */
    ...
    /**
     * Create an instance of {@link GetUserDataFromSpcResponse }
     * 
     */
    public GetUserDataFromSpcResponse createGetUserDataFromSpcResponse() {
        return new GetUserDataFromSpcResponse();
    }
    ...
    /**
     * Create an instance of {@link GetUserDataFromSpc }
     * 
     */
    public GetUserDataFromSpc createGetUserDataFromSpc() {
        return new GetUserDataFromSpc();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link UserProfileData }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://types.detail.ws.rossoalice.telecomitalia.it", name = "userProfileData", scope = UserDetail.class)
    public JAXBElement<UserProfileData> createUserDetailUserProfileData(UserProfileData value) {
        return new JAXBElement<UserProfileData>(_UserDetailUserProfileData_QNAME, UserProfileData.class, UserDetail.class, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link UserPersonalData }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://types.detail.ws.rossoalice.telecomitalia.it", name = "userPersonalData", scope = UserDetail.class)
    public JAXBElement<UserPersonalData> createUserDetailUserPersonalData(UserPersonalData value) {
        return new JAXBElement<UserPersonalData>(_UserDetailUserPersonalData_QNAME, UserPersonalData.class, UserDetail.class, value);
    }
    ...
    public JAXBElement<String> createUserProfileDataUsername(String value) {
        return new JAXBElement<String>(_UserPersonalDataUsername_QNAME, String.class, UserProfileData.class, value);
    }
